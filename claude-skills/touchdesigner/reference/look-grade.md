...
state first ([`play-state`](./play-state.md)).

For transitions and other stateful motion, follow [`reset-state`](./reset-state.md):
...
Use [`timed-capture`](./timed-capture.md) for prepared sample schedules and video jobs;
