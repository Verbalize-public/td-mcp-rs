...
- [`primer/cook-and-families`](../primer/cook-and-families.md) — condensed orientation
- [`pops`](./pops.md) — POP family deep dive
- [`python-api`](./python-api.md) — create/wire patterns
- [`network-design`](./network-design.md) — conventions for built networks


---

**Canonical:** [`operator-families`](./operator-families.md) 