...
TD, and write the cards that make [`palette`](./palette.md) useful — a resumable
...
`spawn_td` creates it from the shipped template. Depth: [`lifecycle`](./lifecycle.md).
...
Grammar: [`opsketch-notation`](./opsketch-notation.md);
what earns a `{}` block: [`opsketch-importance-gating`](./opsketch-importance-gating.md).
...
1. Calls stall → `dialogs` to see if a modal is blocking ([`popups`](./popups.md)).
2. Still wedged → stop new probes; use [`lifecycle`](./lifecycle.md) to stop only
...
live work on one daemon/PID remains sequential ([`tooling-concurrency`](./tooling-concurrency.md)).
...
gotchas. Check it against [`component-checklist`](./component-checklist.md) before describing
...
- Using what you built: [`palette`](./palette.md)
- Spawning the throwaway project: [`lifecycle`](./lifecycle.md)
- Clearing a modal that blocks a probe: [`popups`](./popups.md)
- Writing the sketch in a card: [`opsketch-notation`](./opsketch-notation.md)
- Judging your own components before describing them: [`component-checklist`](./component-checklist.md)

---

**Canonical:** [`palette-scan`](./palette-scan.md)