...
TouchDesigner networks. SoT: [`opsketch-notation`](./opsketch-notation.md) (+ gating / examples).
...
`inputs: []` = unwired. See [`python-api`](./python-api.md) → Wiring.
...
- `{...}` — only parameters that pass the importance gate
  ([`opsketch-importance-gating`](./opsketch-importance-gating.md)). Omit the whole block
...
- `# <comment>` — **last on the line**, the operator's own `OP.comment` as `inspect`
  ...
  Depth: [`node-comments`](./node-comments.md).
...
budget discipline as [`definition-of-done`](./definition-of-done.md).
...
| File | Topic |
|------|-------|
| [`opsketch-importance-gating`](./opsketch-importance-gating.md) | Gating rule + trivial types |
| [`opsketch-examples`](./opsketch-examples.md) | Worked transcriptions |
| [`node-comments`](./node-comments.md) | Writing and reading the `#` text on the live node |
...
**Canonical:** [`opsketch-notation`](./opsketch-notation.md) 