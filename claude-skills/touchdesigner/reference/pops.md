...
- [`operator-families`](./operator-families.md) — family choice and conversions
- [`primer/glsl-and-render`](../primer/glsl-and-render.md) — 3D-to-pixels chain
- [`python-api`](./python-api.md) — POP/SOP geometry surface


---

**Canonical:** [`pops`](./pops.md) 