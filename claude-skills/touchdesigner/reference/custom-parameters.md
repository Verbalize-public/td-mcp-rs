...
Companion to [`component-checklist`](./component-checklist.md). Snippets are sandbox-safe for
...
[`reset-state`](./reset-state.md) contract before calling stateful work complete.
...
- Packaging / About / In-Out rules → [`component-checklist`](./component-checklist.md)
- Par modes (constant/expression/export/bind) → [`primer/parameters-and-channels`](../primer/parameters-and-channels.md)
- Components / tox → [`primer/tox-toe-components`](../primer/tox-toe-components.md)
- Full Python surface → [`python-api`](./python-api.md)


---

**Canonical:** [`custom-parameters`](./custom-parameters.md) 