...
see [`shadertoy-conversion`](./shadertoy-conversion.md) for image-style ports.)
...
your mutation zone ([`mutation-zones`](./mutation-zones.md)).

## Related

- [`glsl`](./glsl.md) — dialect workflow + DoD
- [`shadertoy-conversion`](./shadertoy-conversion.md) — wrap-don't-rewrite port
- [`definition-of-done`](./definition-of-done.md) — structural verdicts


---

**Canonical:** [`td-glsl-ground-truth`](./td-glsl-ground-truth.md) 