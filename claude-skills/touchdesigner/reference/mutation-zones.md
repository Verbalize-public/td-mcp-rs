...
[`custom-parameters`](./custom-parameters.md). Do not stage in a throwaway
...
- [`opsketch-notation`](./opsketch-notation.md) — sketch before mutating
- [`network-design`](./network-design.md) — naming and layout conventions
