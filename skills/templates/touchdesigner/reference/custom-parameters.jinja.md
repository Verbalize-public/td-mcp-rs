...
Companion to {{ skill("component-checklist") }}. Snippets are sandbox-safe for
...
- Packaging / About / In-Out rules → {{ skill("component-checklist") }}
- Par modes (constant/expression/export/bind) → {{ skill("primer/parameters-and-channels") }}
- Components / tox → {{ skill("primer/tox-toe-components") }}
- Full Python surface → {{ skill("python-api") }}


---

**Canonical:** {{ skill("custom-parameters") }} 
