...
- {{ skill("component-checklist") }} — component boundary and reuse
- {{ skill("custom-parameters") }} — public reset control
- {{ skill("play-state") }} — transport and cooking
- {{ skill("definition-of-done") }} — completion evidence
- {{ skill("look-grade") }} — temporal capture evidence

**Canonical:** {{ skill("reset-state") }}
