...
| Extensions, Execute DAT callbacks | `tdmcp://docs/primer/scripting-surfaces` |
| Parameter mode decisions | `tdmcp://docs/primer/parameters-and-channels` |
| OpSketch create/wire recipes | `tdmcp://docs/opsketch-examples` |
