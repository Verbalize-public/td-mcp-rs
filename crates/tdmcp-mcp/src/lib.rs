...
pub use tools::{
    ...
    FormatMode, InspectInclude, InspectParams, MutateNodesParams, MutateStep, ParamsMode,
    SessionGate, ToolCallError, ToolDescriptor, ToolFailPayload, ToolName, API_HELP_QUERIES_LIMIT,
